...
(defn run-tests []
  ...
  (log/info "      ::vsd/is-keyword :data-format/lat-lon-label should be true = " (s/valid? ::vsu/is-keyword :data-format/lat-lon-label))
  (log/info "      ::vsd/is-keyword 42 should be false = " (s/valid? ::vsu/is-keyword 42))
  ...
  (log/info " ")
  (log/info "      explain failure of ::vsd/is-keyword 42: " (s/explain-str ::vsu/is-keyword 42))
